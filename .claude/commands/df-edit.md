...
Find the latest `draft-vN.md` and `review-vN.md` in `workspace/{project}/`. Read both. Apply the human's feedback.

Save the revised document as `workspace/{project}/draft-vN+1.md` (increment the version number by 1).
